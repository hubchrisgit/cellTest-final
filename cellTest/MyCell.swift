...
open class MyCell: UITableViewCell {
    ...
    /// UIView whitch display when cell openƒ
    ...
    //close頁
    @IBOutlet weak var foregroundViewPic: UIImageView!
    @IBOutlet weak var containerViewPic: UIImageView!
    @IBOutlet weak var Flbl_nimal_id: UILabel!
    @IBOutlet weak var Flbl_animal_sex: UILabel!
    @IBOutlet weak var Flbl_animal_area_pkid: UILabel!
    //open頁-第一格
    @IBOutlet weak var open_animal_id: UILabel!
    @IBOutlet weak var open_shelter_name: UILabel!
    @IBOutlet weak var open_shelter_address: UILabel!
    @IBOutlet weak var open_shelter_tel: UILabel!
    @IBOutlet weak var open_animal_foundplace: UILabel!
    //@IBOutlet weak var open_animal_place: UILabel!
    @IBOutlet weak var open_animal_sex: UILabel!
    @IBOutlet weak var open_animal_colour: UILabel!
    @IBOutlet weak var open_animal_bodytype: UILabel!
    @IBOutlet weak var open_animal_age: UILabel!
    @IBOutlet weak var open_animal_sterilization: UILabel!
    @IBOutlet weak var open_animal_bacterin: UILabel!
    @IBOutlet weak var open_animal_remark: UILabel!
    
    @IBOutlet weak var btnOpenFavorite: UIButton!
